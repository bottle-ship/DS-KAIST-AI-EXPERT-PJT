...
def main():
    ...
    print("Freeze Discriminator's weights")
    for i in range(0, 8):
        print(model.discriminator.layers[i])
        model.discriminator.layers[i].trainable = False

    print("Freeze Generator's weights")
    for i in range(0, 12):
        print(model.generator.layers[i])
        model.generator.layers[i].trainable = False
